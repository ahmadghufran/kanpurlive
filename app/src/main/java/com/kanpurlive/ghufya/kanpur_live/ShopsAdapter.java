...
import com.kanpurlive.ghufya.kanpur_live.Shop;
...
class ShopsAdapter extends FirestoreRecyclerAdapter<Shop, ShopsAdapter.ShopViewHolder> {

    // private final Context context;
    String[] list = new String[]{"212","sa"};
    private final Context context;
    ShopsAdapter(FirestoreRecyclerOptions<Shop> options, Context context) {
